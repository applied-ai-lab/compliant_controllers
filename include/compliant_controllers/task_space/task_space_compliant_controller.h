/**
 * \file task_space_compliant_controller.h
 * \mainpage
...
#ifndef COMPLIANT_CONTROLLERS__TASK_SPACE_COMPLIANT_CONTROLLER
...
namespace compliant_controllers {
  ...
  */
  class TaskSpaceCompliantController {
    public:
      /**\fn TaskSpaceCompliantController
       * \brief
      ...
      */
      TaskSpaceCompliantController(std::unique_ptr<pinocchio::Model> robot_model,
                                    std::string const& end_effector_link,
                                    int const num_controlled_dofs);
      TaskSpaceCompliantController() = delete;
      TaskSpaceCompliantController(TaskSpaceCompliantController const&) = default;
      TaskSpaceCompliantController& operator= (TaskSpaceCompliantController const&) = default;
      TaskSpaceCompliantController(TaskSpaceCompliantController&&) = default;
      TaskSpaceCompliantController& operator= (TaskSpaceCompliantController&&) = default;
      ...
      */
      ...
      /**\fn setTaskKMatrix
       * \brief
       *   Set the task space compliance proportional gain matrix
       * 
       * \param[in] task_k_matrix
       *   The task space compliance proportional gain matrix to be set
       * \return
       *   Boolean variable signalling success or failure
      */
      [[nodiscard]]
      bool setTaskKMatrix(Eigen::MatrixXd const& task_k_matrix);

      /**\fn setTaskdMatrix
       * \brief
       *   Set the task compliance derivative gain matrix
       * 
...
#endif // COMPLIANT_CONTROLLERS__TASK_SPACE_COMPLIANT_CONTROLLER

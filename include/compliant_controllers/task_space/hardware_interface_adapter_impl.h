...
namespace compliant_controllers {
  namespace task_space {
    ...
    bool CompliantHardwareInterfaceAdapter<hardware_interface::EffortJointInterface, State>::init(
      ...
      // F6: NaN-diagnostics publisher + 1 Hz timer.  See
      // joint_space adapter for layout reference.
      ...
      diag_timer_ = controller_nh.createTimer(
          ...
          this);
      ROS_INFO("[compliant_controllers/task_space] NaN diagnostics "
    ...
    void CompliantHardwareInterfaceAdapter<hardware_interface::EffortJointInterface, State>::updateCommand(
      ...
      for (Eigen::Index i = 0; i < command_effort_.size(); ++i) {
        ...
        if (!std::isfinite(e)) {
          ...
          ROS_WARN_THROTTLE(
              1.0,
              "[compliant_controllers/task_space] non-finite command "
    ...
    void CompliantHardwareInterfaceAdapter<hardware_interface::EffortJointInterface, 
      State>::dynamicReconfigureCallback(TaskSpaceCompliantControllerConfig const& config,

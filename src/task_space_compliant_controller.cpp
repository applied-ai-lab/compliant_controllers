...
#include "compliant_controllers/task_space_compliant_controller.h"
...
namespace compliant_controllers {
  ...
  void TaskSpaceCompliantController::setDefaultValues() {
  ...
  bool TaskSpaceCompliantController::setJointStiffnessMatrix(
  ...
  bool TaskSpaceCompliantController::setRotorInertiaMatrix(
  ...
  bool TaskSpaceCompliantController::setFrictionL(Eigen::MatrixXd const& friction_l) {
  ...
  bool TaskSpaceCompliantController::setFrictionLp(Eigen::MatrixXd const& friction_lp) {
  ...
  bool TaskSpaceCompliantController::setFrictionLi(Eigen::MatrixXd const& friction_li) {
  ...
  bool TaskSpaceCompliantController::setJointDMatrix(Eigen::MatrixXd const& joint_d_matrix) {
  ...
  bool TaskSpaceCompliantController::setMaxJointError(Eigen::VectorXd const& joint_error_max)
  {
  ...
  Eigen::VectorXd TaskSpaceCompliantController::integrate_error(Eigen::VectorXd const& desired_q,
  ...
  Eigen::MatrixXd TaskSpaceCompliantController::constructDiagonalMatrix(double const value, int const dim) {
  ...
  bool TaskSpaceCompliantController::checkMatrix(Eigen::MatrixXd const& matrix) const noexcept {
